...
function Signup() {
    ...
    const handleSignup = async (data: any) => {
        console.log(data, 's');
        try {
            const postdata = { name: data.name, email: data.email, mobile: data.mobileNo, password: data.password };
                    ...
                    <div className="col-4">
                        <form className="" >
                            ...
                            <div className="form-outlin">
                                ...
                                <input {...register('name')} type="text" id="form3Example1" className="form-control" />
                            </div>
                        ...
                        {msg && <div className="card bg-success" >
